<template>
  <header
    class="tai-header container-fluid p-0"
    :class="{ 'menu-shadow': isMobileMenuOpened }"
  >
    <b-navbar
      toggleable="lg"
      class="header-navbar px-3 py-2 py-lg-3 px-lg-0 container-lg"
    >
      <b-navbar-brand href="#">
        <b-img
          :src="logoImg"
      ...
      >
        ...
        <b-button variant="secondary" class="sign-in-btn mb-2 mb-lg-0"
          >Sign In</b-button
        >
      </b-collapse>
    </b-navbar>
